            ...
            <NavLink to="/ptfd" className="navv2-logo-link">
              <div className="navv2-logo">
                <div className="navv2-logo-icon">
                  <img
                    src={`${process.env.PUBLIC_URL}/WorkflowsEngineering.png`}

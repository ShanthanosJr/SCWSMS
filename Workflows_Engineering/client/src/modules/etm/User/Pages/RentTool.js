...
const API_BASE = process.env.REACT_APP_ETM_API_BASE_URL || "http://localhost:5002/api/tools";
const RENTAL_API_BASE = process.env.REACT_APP_ETM_API_BASE_URL 
  ? process.env.REACT_APP_ETM_API_BASE_URL.replace('/tools', '/rentals') 
  : "http://localhost:5002/api/rentals";
  ...
  if (!tool) {
    return (
      <div className="text-center py-5">
        ...
        <button className="btn btn-secondary" onClick={() => navigate("/etm/user/tools")}>
          Back to Tools
        </button>
      </div>
    );
      ...
      <div className="row justify-content-center">
        <div className="col-md-8">
          <button 
            ...
            onClick={() => navigate("/etm/user/tools")}
          >
            Back to Tools
          </button>
